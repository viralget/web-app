...
export function formatMailTo(job) {
    return `mailto:${job.application_email}?subject=Application for the role of ${job.job_title}&body= Dear Hiring Manager,%0D%0A%0D%0A I would like to apply for the role of ${job.job_title} as described on ${job.job_url}.%0D%0A%0D%0A Best Regards,`;
}
