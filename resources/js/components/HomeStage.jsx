                              ...
                              
                              {
                                Tabs.map((item) => (
                                  <li className="w-full   lg:w-auto">
                                        <button onClick={() => handleSetTab(item)} className={classNames("font-lexend w-full lg:w-auto font-medium px-space-40 py-space-15  z-10 text-t-xsx ", selectedTab === item ? ' bg-viralget-grey rounded-md text-white' : 'text-viralget-grey' )}>
                                            {item}
                                        </button>
                                   </li>   
                                ))
