...
//                 currency: 'usd',
//                 total: {
//                     label: metadata?.details ?? 'Hireme Payment',
//                     amount: amount * 100,
//                 },
...
//             const data = { amount, type, payment_method_id: ev.paymentMethod.id, customer_id: customer.data.id, metadata };
...
//         return <Button isLink={isLink} usePrimary disabled={disabled} className={className} onClick={() => {
//             paymentRequest.show()
