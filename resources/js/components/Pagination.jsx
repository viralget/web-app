...
export default function Pagination({ data, simpleData, paginationURL, useSimple }) {
  ...
  return (
    useSimple ? <SimplePagination data={data} paginationURL={paginationURL} /> :
            ...
            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
              ...
              {links.map((item, key) => (
                <a
                  ...
                  className={`${item.active ? 'bg-indigo-600 text-white' : 'bg-white text-gray-500'} border-gray-300  hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium`}
                >
