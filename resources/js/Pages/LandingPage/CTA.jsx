            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="px-8 py-10 overflow-hidden lg:px-24 md:py-20 bg-gray-50 rounded-3xl">
                    <div className="max-w-lg mx-auto text-center">
                        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">Get a compiled list of 60 influencers of any size</h2>
                        <p>Access a list of over 60 influencers of any size and in any industry of your choosing </p>
                    </div>
                    ...
                    <ul className="flex flex-col items-center justify-center mt-8 space-y-5 sm:mt-12 lg:mt-16 md:flex-row md:space-y-0 md:space-x-12">
                        <li className="flex items-center text-gray-900">
                            ...
                            <span className="ml-3 text-lg font-bold font-pj"> Discounted price of <s>N40,000</s> N19,999 </span>
                        </li>
                    ...
                    <div className="mt-8 text-center sm:mt-12">
                        <div className="relative inline-flex group">
                            ...
                            <a
                                ...
                                role="button"
                            >
                                Get started, Pre order now
                            </a>
                        </div>

                        <p className="mt-5 text-sm font-normal text-gray-500 font-pj">Offer valid until 8th of July, 2023</p>
                    </div>
                </div>
            </div>
        </section>
