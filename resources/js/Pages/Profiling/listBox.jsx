...
export default function ListBox({ item, handleAddInfluencer }) {
    ...
    const EmptyBox = () => (
        ...
        <div className="bg-[#E8E9F1] flex justify-center w-full h-44 items-center rounded-md">
            ...
            <div className="border rounded-md p-3  "  >
                {
                    images.length > 0 ?
                        (
                            <a href={route('single.list', { id: item.id })} >
                                <div className="grid grid-cols-2 gap-2">
                                    {
                                        images.slice(0, 4).map((img) => (
                                            <div>
                                                <img className="w-full h-44 object-cover  rounded-md" src={img.image_url} />
                                            </div>
                                        ))
                                    }
                                    {
