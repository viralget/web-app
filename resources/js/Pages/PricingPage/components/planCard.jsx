...
export default function PlanCard({item, isEmpty}) {
  ...
  const plan  = item ?? null;
    return (
        <div  className="border  border-viralget-gray-300  flex flex-col  p-2 lg:w-space-200 h-space-200  w-full  items-center justify-center">
             {
              isEmpty ? (
                <span className="font-bold  text-t-xs font-lexend text-center ">Pick a plan</span>
              )
              : (
                <>
                  {
