...
class Thread extends Eloquent
{
     ...
     * @var array
     */
    protected $fillable = ['subject', 'initiator_id', 'receiver_id'];
    ...
    public function scopeForUser(Builder $query, $userId)
    {
        ...
        // return $this->rightJoin($participantsTable, $this->getQualifiedKeyName(), '=', $participantsTable . '.thread_id')->where($participantsTable . '.user_id', $userId)->select($threadsTable . '.*');
    ...
    {
        return  $this->whereHas('participants', function ($query) use ($userId) {
